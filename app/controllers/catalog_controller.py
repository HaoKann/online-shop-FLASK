...
def graphics_card():
    page = request.args.get('page', 1, type=int)
    gpu_products = Product.query.join(Category).filter(Category.slug == 'gpu').paginate(page=page, per_page=10)
...
def processor():
    page = request.args.get('page', 1, type=int)
    processor_products = Product.query.join(Category).filter(Category.slug == 'cpu').paginate(page=page, per_page=10)
...
def motherboard():
    page = request.args.get('page', 1, type=int)
    motherboard_products = Product.query.join(Category).filter(Category.slug == 'motherboard').paginate(page=page, per_page=10)
...
def power_supply_unit():
    page = request.args.get('page', 1, type=int)
    psu_products = Product.query.join(Category).filter(Category.slug == 'psu').paginate(page=page, per_page=10)
...
def random_access_memory():
    page = request.args.get('page', 1, type=int)
    ram_products = Product.query.join(Category).filter(Category.slug == 'ram').paginate(page=page, per_page=10)
...
def cooling_system():
    page = request.args.get('page', 1, type=int)
    cooler_products = Product.query.join(Category).filter(Category.slug == 'cooler').paginate(page=page, per_page=10)
...
def storage():
    page = request.args.get('page', 1, type=int)
    storage_products = Product.query.join(Category).filter(Category.slug == 'storage').paginate(page=page, per_page=10)
...
def computer_case():
    page = request.args.get('page', 1, type=int)
    case_products = Product.query.join(Category).filter(Category.slug == 'pc_case').paginate(page=page, per_page=10)
